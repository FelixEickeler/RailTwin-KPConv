...
class Config:
    ...
    def save(self):
        ...
        with open(join(self.saving_path, 'parameters.txt'), "w") as text_file:
            ...
            # Updated parameters
            # text_file.write('# Dataset Parameters\n')
            # text_file.write('# *****************\n\n')
            # if hasattr(self, "dataset_name"):
            #     text_file.write('dataset_name = {:s}\n'.format(self.dataset_name))
            # if hasattr(self, "labels"):
            #     text_file.write("labels=")
            #     for name, id in self.labels.items():
            #         text_file.write(f'{name}:{id}}'.format(self.labels))
            #     text_file.write('\n')
            # if hasattr(self, "ignored_labels"):
            #     text_file.write('ignored_labels = {:s}\n'.format(self.dataset_name))
